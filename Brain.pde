...
class Brain {
  ...
  void findBestMoves(int piece, int nextPiece, int[][][] board, int[] backgroundColor) {
    ...
    PathFinder P = new PathFinder(piece, nextPiece, board, backgroundColor, heightFactor, linesFactor, holesFactor, bumpFactor, nextAH, nextL, nextH, nextB, pos1Factor, pos2Factor);
    P.findBestMoves();
